...
// dependencies
require(ROOT_KIRBY_TOOLKIT_CLASSES . DS . 'uri' . DS . 'params.php');
require(ROOT_KIRBY_TOOLKIT_CLASSES . DS . 'uri' . DS . 'path.php');
require(ROOT_KIRBY_TOOLKIT_CLASSES . DS . 'uri' . DS . 'query.php');
